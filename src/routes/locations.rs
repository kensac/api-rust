...
#[axum::debug_handler]
#[utoipa::path(post, path = "/location", responses((status = 200, description = "Create a new location", body = String), (status=400, description = "Bad request")), request_body = CreateLocationEntity)]
...
#[axum::debug_handler]
#[utoipa::path(get, path = "/locations", responses((status = 200, description = "Get all locations"), (status=400, description = "Bad request")))]
...
#[axum::debug_handler]
#[utoipa::path(get, path = "/locations/{id}", responses((status = 200, description = "Get a location by id"), (status=400, description = "Bad request")))]
...
#[axum::debug_handler]
#[utoipa::path(delete, path = "/locations/{id}", responses((status = 200, description = "Delete a location by id"), (status=400, description = "Bad request")))]
