...
#[axum::debug_handler]
#[utoipa::path(get, path = "/extra_credit/classes", responses((status = 200, description = "Get all extra credit classes"), (status=400, description = "Bad request")))]
...
#[axum::debug_handler]
#[utoipa::path(get, path = "/extra_credit/classes/{id}", responses((status = 200, description = "Get a extra credit class by id"), (status=400, description = "Bad request")))]
...
#[axum::debug_handler]
#[utoipa::path(delete, path = "/extra_credit/classes/{id}", responses((status = 200, description = "Delete a extra credit class by id"), (status=400, description = "Bad request")))]
